...
//
// modelHash    — unique fingerprint sent by Flask (MD5 of model files); idempotency key.
...
public class EnsembleConfiguration {
    ...
    // Populated once when the configuration is first registered. Read-only after that.
